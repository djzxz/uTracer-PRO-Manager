...
$good="<Button Content=\"★ ULUBIONE\" Command=\"{Binding ToggleFavoriteCommand}\" Margin=\"0,0,8,0\"/>`n                  <Button Content=\"EDYTUJ BLOCKED / PENDING\" Command=\"{Binding LoadDatabaseProfileEditorCommand}\" />"
