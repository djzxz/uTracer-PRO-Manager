...
$vm = Replace-Required $vm "            await SearchAsync();`n            await _history.InitializeAsync();" "            await SearchAsync();`n            await InitializeProfileWorkQueueAsyncV140();`n            await _history.InitializeAsync();" 'queue startup hook'
